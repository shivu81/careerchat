...
import type { Session as _Session } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deleteSession(arg0: SessionId): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async listSessions(): Promise<Array<SessionSummary>> {
        if (this.processError) {
            try {
    ...
    async saveSession(arg0: SessionId, arg1: SessionData): Promise<boolean> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Session]): Session | null {
